...
# Путь к директории с исправленными изображениями
showcase_dir = 'src/data/showcase_fixed'

print("Проверяем исправленные изображения:")
print("-" * 50)
