...
Готовые адаптеры развернуты на бессерверной инфраструктуре Yandex Cloud и способны выдерживать большое количество запросов. [Конфигурации публичных эндпоинтов.](deploy.mdx#конфигурация-env-файл)
