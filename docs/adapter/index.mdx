...
*Данный проект не является официальным продуктом Yandex Cloud. Поддерживается командой ai-cookbook.ru.* [Голосование за OpenAI-compatible API в YC](https://yandex.cloud/ru/features/4631)
